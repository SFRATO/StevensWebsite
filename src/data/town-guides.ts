...
export const townGuides: TownGuide[] = [
  // ── Burlington County ─────────────────────────────────────────────────────
  {
    ...
    zipcode: '08002',
    blurb: 'Cherry Hill is one of South Jersey\'s most established suburban communities, known for its diverse neighborhoods, strong schools, and convenient access to Philadelphia. It offers a wide range of housing styles from mid-century ranches to newer construction.',
    commute: '15–25 minutes to Center City Philadelphia via Route 38 and I-676. NJ Transit bus service available.',
    schoolNote: 'Cherry Hill School District — two high schools (Cherry Hill East and Cherry Hill West), consistently rated among the top districts in South Jersey.',
    lifestyle: 'Abundant shopping and dining along Route 70 and the Cherry Hill Mall area. Diverse community with a strong sense of neighborhood pride.',
  },
  {
    townName: 'Marlton',
    county: 'Burlington County',
    countySlug: 'burlington-county',
    zipcode: '08053',
    blurb: 'Marlton is a popular Burlington County community offering newer planned developments, good schools, and easy highway access. It attracts families and professionals who want suburban comfort with a short commute.',
    commute: '25–35 minutes to Philadelphia via Route 73 and I-295. Close to the NJ Turnpike (Exit 4).',
    schoolNote: 'Evesham Township School District — Lenape High School serves upper grades, consistently ranked among South Jersey\'s better districts.',
    lifestyle: 'Extensive retail and restaurant corridor along Route 73. Popular with young families. Strong youth sports culture and community events.',
  },
  {
    townName: 'Moorestown',
    county: 'Burlington County',
    countySlug: 'burlington-county',
    zipcode: '08057',
    blurb: 'Moorestown is one of the most sought-after addresses in South Jersey — a historic town center, tree-lined streets, and consistently top-ranked schools make it a premium destination. The housing stock includes grand Victorians, colonials, and newer custom homes.',
    commute: '20–30 minutes to Philadelphia. Easy access to Route 38, I-295, and NJ Turnpike.',
    schoolNote: 'Moorestown School District — Moorestown High School is regularly ranked among New Jersey\'s top 10 high schools.',
    lifestyle: 'Charming main street with boutique shops and restaurants. Strong historic preservation ethic. Low crime, family-friendly, and walkable town center.',
  },
  {
    ...
    countySlug: 'burlington-county',
    zipcode: '08054',
    blurb: 'Mount Laurel is a large, diverse township offering something for everyone — from affordable townhouses and condos to sprawling single-family homes in established neighborhoods. Its central location makes it a hub for South Jersey commerce.',
    ...
    lifestyle: 'Extensive commercial development along Route 73. Large employer base with many corporate headquarters. Diverse and rapidly growing community.',
  },
  {
    townName: 'Bordentown',
    county: 'Burlington County',
  ...
  },
  {
    ...
    countySlug: 'burlington-county',
    zipcode: '08055',
    blurb: 'Medford offers a pastoral setting with a walkable historic village center and access to the Pinelands. It\'s known for larger lots, equestrian properties, and a quiet, rural character that attracts buyers seeking space without sacrificing quality schools.',
  ...
  // ── Mercer County ─────────────────────────────────────────────────────────
  {
    ...
    zipcode: '08540',
    blurb: 'Princeton is home to Princeton University and carries an intellectual, cultural energy unlike anywhere else in central NJ. The borough combines Ivy League prestige with a vibrant arts scene, exceptional dining, and a highly educated population.',
    ...
    schoolNote: 'Princeton Public Schools — Princeton High School is consistently ranked among New Jersey\'s top public schools.',
    lifestyle: 'World-class dining, theater, and museums. Palmer Square shopping and events. Strong international community. High walkability in the borough. Exceptional cultural programming.',
  },
  {
    ...
    countySlug: 'mercer-county',
    zipcode: '08691',
    blurb: 'Robbinsville is one of central NJ\'s fastest-growing communities, offering newer planned developments, excellent schools, and a growing town center. It attracts professional families drawn by top schools and a modern, well-planned community.',
    commute: '65–80 minutes to NYC via NJ Transit from Hamilton Station. 45–55 minutes to Philadelphia via I-295.',
    schoolNote: 'Robbinsville School District — Robbinsville High School consistently ranks among the top public high schools in NJ.',
    lifestyle: 'Town Center with shops, restaurants, and community events. Growing Sikh cultural community. Strong youth athletics programs. Newer construction with modern amenities.',
  },
  {
    townName: 'Hamilton',
    county: 'Mercer County',
    countySlug: 'mercer-county',
    zipcode: '08610',
    blurb: 'Hamilton Township is the largest municipality in Mercer County by population, offering diverse housing options at relatively affordable prices. Its central location and NJ Transit access make it a practical choice for commuters in both directions.',
    ...
    lifestyle: 'Diverse community with a wide range of neighborhoods. Multiple shopping districts. Abbott Marshlands nature preserve. Strong local business community.',
  },
  {
    townName: 'Lawrence',
    county: 'Mercer County',
  ...
  // ── Middlesex County ──────────────────────────────────────────────────────
  {
    ...
    zipcode: '08817',
    blurb: 'Edison is one of NJ\'s most diverse and populous townships, named after Thomas Edison who did much of his landmark work here. It offers a wide range of housing and is particularly known for its large South Asian community and excellent dining.',
    ...
    lifestyle: 'Exceptional Indian and Asian dining along Oak Tree Road and Route 27. Major retail centers. Thomas Edison National Historical Park. Vibrant multicultural community.',
  },
  {
    ...
    countySlug: 'middlesex-county',
    zipcode: '08816',
    blurb: 'East Brunswick is a well-established Middlesex County township known for good schools, diverse neighborhoods, and a strong sense of community. It offers a range of housing types from modest ranches to large colonials.',
    commute: '55–65 minutes to NYC via NJ Transit bus from Route 18 park-and-ride. Easy Route 18 and Route 9 access.',
    schoolNote: 'East Brunswick Public Schools — East Brunswick High School is well-regarded and offers a wide range of programs.',
    lifestyle: 'Extensive commercial corridor on Route 18. Large Jewish community with multiple synagogues. Good parks system. Popular with families.',
  },
  {
    townName: 'Old Bridge',
    county: 'Middlesex County',
    countySlug: 'middlesex-county',
    zipcode: '08857',
    blurb: 'Old Bridge is a sprawling Middlesex County township with diverse neighborhoods, from waterfront communities on Raritan Bay to inland suburban developments. It offers relatively affordable prices for the Middlesex market.',
  ...
  },
  {
    ...
    lifestyle: 'Woodbridge Center mall area. Barron Arts Center. Diverse community. Multiple distinct neighborhoods with their own character.',
  },
  {
    townName: 'Piscataway',
    county: 'Middlesex County',
    countySlug: 'middlesex-county',
    zipcode: '08854',
    blurb: 'Piscataway is home to Rutgers University and offers an academic atmosphere with diverse housing stock ranging from affordable to upscale. It\'s popular with university faculty, staff, and graduate students.',
    ...
    lifestyle: 'Rutgers University presence drives cultural programming and diversity. Johnson Park along the Raritan River. Several major corporate campuses.',
  },
  {
    ...
    countySlug: 'middlesex-county',
    zipcode: '08852',
    blurb: 'South Brunswick is a rapidly growing township with planned communities, good schools, and strong appeal to South Asian families. Its location between Route 1 and Route 27 provides good highway access.',
    commute: '60–75 minutes to NYC via NJ Transit bus or driving to Princeton Junction. Close to Route 1 tech corridor.',
    schoolNote: 'South Brunswick School District — South Brunswick High School is well-regarded and serves a diverse student body.',
    lifestyle: 'Growing Indian and South Asian community. Multiple cultural centers. New construction communities. Strong Route 1 tech employment corridor.',
  },
  {
    townName: 'Metuchen',
    county: 'Middlesex County',
