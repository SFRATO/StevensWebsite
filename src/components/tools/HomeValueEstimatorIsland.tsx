...
const s = {
  ...
  stepLabel: { fontFamily: theme.fontUi, fontSize: '0.75rem', fontWeight: 700, color: theme.textMuted, textTransform: 'uppercase' as const, letterSpacing: '0.08em', marginBottom: '0.5rem' },
  heading: { fontFamily: theme.fontHeading, fontVariantNumeric: 'tabular-nums' as const, fontSize: '1.25rem', fontWeight: 700, color: theme.textPrimary, margin: '0 0 1.5rem' },
  optionGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.75rem', marginBottom: '1.5rem' },
  option: (active: boolean) => ({ fontFamily: theme.fontUi,
  ...
  pill: (active: boolean) => ({ fontFamily: theme.fontUi,
    padding: '0.5rem 1rem',
    borderRadius: '999px',
    border: `2px solid ${active ? theme.accent : theme.ruleStrong}`,
  ...
  pillLabel: { fontFamily: theme.fontUi, fontSize: '0.75rem', color: theme.textSecondary, marginBottom: '0.5rem', fontWeight: 500 },
  btn: { fontFamily: theme.fontUi,
    width: '100%',
    padding: '1rem',
  ...
  resultValue: { fontFamily: theme.fontHeading, fontVariantNumeric: 'tabular-nums' as const, fontSize: '2rem', fontWeight: 700, color: theme.textPrimary, margin: '0.25rem 0' },
  rangeRow: { display: 'flex', gap: '2rem', marginTop: '1rem' },
  rangeItem: { flex: 1 },
  rangeItemLabel: { fontFamily: theme.fontUi, fontSize: '0.75rem', color: theme.textMuted },
  rangeItemValue: { fontFamily: theme.fontHeading, fontVariantNumeric: 'tabular-nums' as const, fontSize: '1.1rem', fontWeight: 600, color: theme.ruleStrong },
  ...
  statValue: { fontFamily: theme.fontHeading, fontVariantNumeric: 'tabular-nums' as const, fontSize: '1.25rem', fontWeight: 700, color: theme.textPrimary },
  statLabel: { fontFamily: theme.fontUi, fontSize: '0.75rem', color: theme.textSecondary, marginTop: '0.25rem' },
  ...
  basisNote: { fontFamily: theme.fontUi, fontSize: '0.8rem', color: theme.textMuted, marginTop: '0.75rem', fontStyle: 'italic' as const },
